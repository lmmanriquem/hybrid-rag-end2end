...
| Experiment | Dataset | α | Time (M4 Max) | Status | EM |
|---|---|---|---|---|---|
...
| **Mini-ablation** | SQuAD mini | 0.3 / 0.5 / 0.7 | ~5h total | ✅ Done | α=0.7 wins (12.00%) |
| **Mini-ablation** | QAConv mini | 0.3 / 0.5 / 0.7 | ~2.5h total | ✅ Done | α=0.7 wins (25.00%) |
